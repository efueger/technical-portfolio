...
- [Main README](../README.md) - Overview of all workflow automation projects
- [LESSONS_LEARNED.md](./LESSONS_LEARNED.md) - Detailed reflections
- [workflow.json](./workflow.json) - Importable n8n workflow
